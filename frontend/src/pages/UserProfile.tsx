...
const UserProfile = () => {
    ...
    const myRecipes = useRecipesStore(state => state.myRecipes);
    const fetchMyRecipes = useRecipesStore(state => state.fetchMyRecipes);
                                            ...
                                            <div key={recipe.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <button
                                                        ...
                                                        className="inline-flex items-center justify-center w-full px-4 py-2 bg-orange-500 text-white text-sm font-medium rounded-md hover:bg-orange-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2"
                                                    >
                                                        View Recipe
